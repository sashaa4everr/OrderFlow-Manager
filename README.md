# OrderFlow-Manager
-ESP VER.-
Hola y bienvenido a la guia de ejecución para OrderFlow Manager.
Por favor, antes de ejecutar el programa tenga encuenta estas indicaciones:
- Asegurese de que su computadora posea las siguientes librerias:
- Tkinter
- CustomTkinter
- Pillow
- io
